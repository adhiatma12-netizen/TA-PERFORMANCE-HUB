...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    stageAssuranceTicketPerf: '🛠️ Performansi Assurance - Ringkasan & Agregasi Tiket',
    stageAssuranceOperations: '🛠️ Performansi Assurance - Evaluasi Solusi Tiket',
    stageAssuranceTicketLogs: '📋 Performansi Assurance - Detail Transaksi & Log Tiket (2.649 Tiket)',
    stageAssuranceKpiIoan: '🏆 Performansi Assurance - KPI IOAN',
    stageAssuranceKpiAssurance: '🏆 Performansi Assurance - KPI ASSURANCE',
    stageProvisioning: '📦 Performansi Pemasangan Baru IndiHome (Provisioning)',

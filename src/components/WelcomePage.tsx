  ...
  const modules = [
    {
      ...
      category: 'Finansial & KPI',
      icon: BarChart3,
      themeColor: 'emerald',
      iconBg: 'bg-emerald-50 text-emerald-600 border-emerald-200',
      badgeBg: 'bg-emerald-50 text-emerald-700 border-emerald-200',
      summary: 'Monitoring indikator finansial kunci meliputi realisasi Revenue, COGS, EBITDA Margin, OPEX, CAPEX, serta perbandingan profitabilitas antar regional.',
      tags: ['Revenue & EBITDA', 'Cost Structure', 'Margin Regional', 'Filter Periode'],
    },
    {
      id: 'assurance',
      title: 'Performansi Assurance',
      category: 'Stabilitas Jaringan',
      icon: ShieldCheck,
      themeColor: 'blue',
      iconBg: 'bg-blue-50 text-blue-600 border-blue-200',
      badgeBg: 'bg-blue-50 text-blue-700 border-blue-200',
      summary: 'Pemantauan kehandalan tiket gangguan pelanggan, pemenuhan Service Level Agreement (SLA), waktu rata-rata perbaikan (MTTR), serta tren backlog tiket.',
      tags: ['SLA Compliance', 'MTTR (Jam)', 'Backlog Tiket', 'Sebaran Produk'],
    },
    {
      id: 'provisioning',
      title: 'Performansi Provisioning',
      category: 'Pasang Baru',
      icon: UserPlus,
      themeColor: 'violet',
      iconBg: 'bg-violet-50 text-violet-600 border-violet-200',
      badgeBg: 'bg-violet-50 text-violet-700 border-violet-200',
      summary: 'Pengawasan pemenuhan instalasi pasang baru IndiHome & segmen Indibizz, analisis performa sektor, status Kpro, dan peta interaktif koordinat instalasi.',
      tags: ['Realisasi PSB', 'Lead Time Order', 'Status Kpro', 'Peta Koordinat'],
    },
    {
      id: 'qe',
      title: 'Performansi QE',
      category: 'Safety & Mutu K3',
      icon: ClipboardCheck,
      themeColor: 'amber',
      iconBg: 'bg-amber-50 text-amber-600 border-amber-200',
      badgeBg: 'bg-amber-50 text-amber-700 border-amber-200',
      summary: 'Audit Quality Engineering & kepatuhan K3 lapangan, kesesuaian standardisasi material (kabel/ODP/closure), dan pelaksanaan Preventive Maintenance.',
      tags: ['Skor QE Mutu', 'Patroli K3 Lapangan', 'Standar Material', 'Preventive Maint.'],
    },
    {
      id: 'technician',
      title: 'Performansi Teknisi',
      category: 'Produktivitas Personel',
      icon: Users,
      themeColor: 'rose',
      iconBg: 'bg-rose-50 text-rose-600 border-rose-200',
      badgeBg: 'bg-rose-50 text-rose-700 border-rose-200',
      summary: 'Evaluasi produktivitas teknisi lapangan, tracking penyelesaian tiket reguler & gamas, rasio ONT underspec, leaderboard, serta kepuasan pelanggan.',
      tags: ['Skor Produktivitas', 'Leaderboard', 'Tiket Reguler & Gamas', 'ONT & Underspec'],
    },
    {
      id: 'kelola-data',
      title: 'Kelola Data Spreadsheet',
      category: isOwner ? 'Akses Owner' : 'Restricted',
      icon: Database,
      themeColor: 'slate',
      ...
      summary: 'Pusat integrasi langsung dengan Google Spreadsheet resmi (Master Endstate, GD Indibizz, Rekap QE) dan manajemen hak akses pengguna.',
      tags: ['Live Sync Sheets', 'Struktur Header', 'Hak Akses User', 'Status Koneksi'],
    },
  ];
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-xs text-center">
          <div className="space-y-3 max-w-3xl mx-auto flex flex-col items-center">
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-red-50 border border-red-200/80 text-red-700 text-xs font-semibold">
              ...
              <span>Portal Terpadu Monitoring Performansi</span>
            </div>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-black text-slate-900 tracking-tight">
              Selamat Datang di Telkom Akses Performance Control HUB
            </h1>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed max-w-2xl mx-auto">
              Platform terpadu untuk monitoring dan analisa performansi operasional Telkom Akses guna mempermudah pemantauan indikator kinerja utama.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 sm:p-6 border border-slate-200/90 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Klik tombol di samping untuk langsung masuk ke halaman utama performansi.
            </p>
          </div>
          ...
          <button
            ...
            id="btn-next-bottom"
          >
            <span>Lanjut ke Halaman Utama</span>
      ...
      <footer className="bg-white border-t border-slate-200 py-4 text-center text-xs text-slate-400 mt-auto">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-2">
          ...
          <div className="flex items-center space-x-1.5 text-[11px] text-slate-500">
            ...
            <span>Service Area Performance Dashboard</span>
          </div>
        </div>
      </footer>
    </div>

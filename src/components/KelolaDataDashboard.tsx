...
import { SystemProcessFlowChart } from './SystemProcessFlowChart';
...
export default function KelolaDataDashboard({
  ...
  return (
    <div className="space-y-8 animate-fade-in" id="kelola-data-dashboard">
      ...
      {/* 5. SECTION: SYSTEM PROCESS FLOW CHART (DIAGRAM ALUR PROSES WEB) */}
      <div className="bg-white rounded-3xl p-6 lg:p-8 border border-slate-200 shadow-sm space-y-6" id="system-process-flowchart-section">
        <SystemProcessFlowChart
          indicators={indicators}
          onInspectIndicatorLogic={handleInspectIndicatorLogic}
        />
      </div>

      {/* 6. INTERACTIVE COLUMN LOGIC INSPECTION MODAL (OWNER DATA AUDIT) */}
      <ColumnLogicModal
